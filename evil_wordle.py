...
On my honor, FDaniela Gutierrez, this
...
class Keyboard:
    ...
    def update(self, feedback_colors, guessed_word):
        ...
        for i, color in enumerate(feedback_colors):
            ...
            elif color == WRONG_SPOT_COLOR and self.colors[guessed_word[i]] != CORRECT_COLOR:
                self.colors[guessed_word[i]] = WRONG_SPOT_COLOR
            elif color == NOT_IN_WORD_COLOR and self.colors[guessed_word[i]] == NO_COLOR:
...
class WordFamily:
    ...
    def __lt__(self, other):
        ...
        # Compare based on difficulty in descending order
...
def get_feedback_colors(secret_word, guessed_word):
    ...
    for i in range(NUM_LETTERS):
        if guessed_word[i] == secret_word[i]:
            ...
            secret_word_count[guessed_word[i]] -= 1

    for i in range(NUM_LETTERS):
        if (
            guessed_word[i] != secret_word[i]
            and guessed_word[i] in secret_word_count
            and secret_word_count[guessed_word[i]] > 0
        ):
